        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/logo.png') }}" alt="" height="17">
                    </span>
                </a>

                <a href="/" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset ('/logo.png') }}" alt="" height="28">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/logo.png') }}" alt="" height="70">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar.png') }}"
                    alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="{{ route('updateProfile') }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">โปรไฟล์</span></a>
                <a class="dropdown-item" href="{{ route('wallet.index') }}"><i class="bx bx-wallet font-size-16 align-middle me-1"></i> <span key="t-my-wallet">กระเป๋าเงิน</span></a>
