        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <span key="t-dashboards">ภาพรวม</span>
                    </a>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-user-circle"></i>
                        <span key="t-ecommerce">โปรไฟล์</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('updateProfile') }}" key="t-boxicons">แก้ไขข้อมูลส่วนตัว</a></li>
                        <li><a href="{{ route('changePassword') }}" key="t-boxicons">เปลี่ยนรหัสผ่าน</a></li>
                    </ul>
                </li>
                ...
                {{-- <li>
                    <a href="{{ route('package.index') }}" class="has-arrow waves-effect">
                        <i class="bx bx-package"></i>
                        <span key="t-maps"> Package </span>
                    </a>
                </li> --}}

               <li>
                    {{-- <a href="{{ route('wallet.index') }}" class="has-arrow waves-effect"> --}}
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-wallet"></i>
                        <span key="t-calendar"> WALLET </span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('wallet.index') }}" key="t-calendar"> WALLETS </a></li>
                        <li><a href="{{ route('wallet.cash-wallet.index') }}" key="t-calendar"> CASH - WALLET </a></li>
                        <li><a href="{{ route('wallet.coin-wallet.index') }}" key="t-calendar"> COIN - WALLET </a></li>
                    </ul>
                </li>
                ...
                {{-- <li>
                    <a href="{{ route('admin.withdraw.index') }}" class="has-arrow waves-effect">
                        <i class="bx bx-up-arrow-alt "></i>
                        <span key="t-maps"> รายการขอถอนเงิน </span>
                    </a>
                </li>
               ...
               <li>
                    <a href="#" class="has-arrow waves-effect">
                        <i class="bx bx-wallet"></i>
                        <span key="t-icons"> Report </span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.report.summary-in-out.index') }}" key="t-boxicons"> รายงานสรุปรายได้ </a></li>
