            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('createUser') }}" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input @error('position_space') is-invalid @enderror" type="radio" id="formRadios1" name="position_space" value="left" {{ $position == 'left' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="formRadios1">
                                                ซ้าย
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input @error('position_space') is-invalid @enderror" type="radio" name="position_space" value="right" id="formRadios2" {{ $position == 'right' ? 'checked' : '' }}>
                        ...
                        <h4 class="card-title mb-4 mt-4">Password</h4>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="formrow-password-2" class="form-label">Re-Type Password</label>
